...
public class World {
    ...
    public void render(Graphics g){
        ...
        for (GameObject obj : objects) {
            if (obj instanceof Cockroach || obj instanceof Bird || obj instanceof Player || obj instanceof Janitor || obj instanceof EvilCar || obj instanceof RatTrap || obj instanceof Chef || obj instanceof Student) {
                obj.render(g);
            }
        }
