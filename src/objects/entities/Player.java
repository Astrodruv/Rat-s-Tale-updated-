...
//            PlayerValues.isPlayerUsingKnife = false;
    ...
    public void keyPressed(int key, char c){
        ...
        if (key == (Input.KEY_S) && dashTimer <= 0 && dashCooldown <= 0 && !trapped) {
